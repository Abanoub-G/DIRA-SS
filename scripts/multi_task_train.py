...
from utils.multi_task_model import model_selection, train_model, save_model
from utils.dataloaders import pytorch_dataloader, pytorch_dataloader_with_rotation
...
def main():
    ...
    print("FP32 evaluation classification accuracy: {:.3f}".format(eval_accuracy))
    print("FP32 evaluation rotation accuracy: {:.3f}".format(eval_rot_accuracy))
